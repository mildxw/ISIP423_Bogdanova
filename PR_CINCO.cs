...
public class Program
{
    ...
    {
        Manager.AddStudent("Степан Петров");
        Manager.AddStudent("Джамаль Русский");
        Manager.AddTeacher("Евгений Банный");
        Manager.AddTeacher("Жанырбек Кумысов");
        Manager.AddCourse("Введение в C#");
        Manager.AddCourse("Теория баз данных");

        Manager.AssignTeacherToCourse("Жанырбек Кумысов", "Введение в C#");
        Manager.AssignTeacherToCourse("Жанырбек Кумысов", "Теория баз данных");
        
        Manager.EnrollStudentInCourse("Евгений Банный", "Введение в C#");
        Manager.EnrollStudentInCourse("Степан Петров", "Теория баз данных");
        Manager.EnrollStudentInCourse("Джамаль Русский", "Введение в C#");
    }
}
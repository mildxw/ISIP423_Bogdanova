...
class Game
{
    ...
    private void OpenChest()
    {
        ...
        {
            case 0:
                Console.WriteLine("Эликсир жизни");
                player.Heal();
                break;
            case 1:
...
class Kolesnitsa : Skeleton
{
    public Kolesnitsa()
    {
        Name = "Колесница из дс1";
        HP = (int)(HP * 2.5);
